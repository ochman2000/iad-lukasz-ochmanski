...
public class Zadanie2bCopy {
	...
	public static void main(String[] args) {
		new Zadanie2bCopy(new Zadanie2b1(), "sprawozdanie/dane/b/test01.txt");
		new Zadanie2bCopy(new Zadanie2b2(), "sprawozdanie/dane/b/test02.txt");
		new Zadanie2bCopy(new Zadanie2b3(), "sprawozdanie/dane/b/test03.txt");
		new Zadanie2bCopy(new Zadanie2b4(), "sprawozdanie/dane/b/test04.txt");
		new Zadanie2bCopy(new Zadanie2b5(), "sprawozdanie/dane/b/test05.txt");
		new Zadanie2bCopy(new Zadanie2b6(), "sprawozdanie/dane/b/test06.txt");
		new Zadanie2bCopy(new Zadanie2b7(), "sprawozdanie/dane/b/test07.txt");
		new Zadanie2bCopy(new Zadanie2b8(), "sprawozdanie/dane/b/test08.txt");
		new Zadanie2bCopy(new Zadanie2b9(), "sprawozdanie/dane/b/test09.txt");
	}
